...
class GenerosResultBookPage extends StatefulWidget {
  final String genero;
  const GenerosResultBookPage(this.genero, {Key key}) : super(key: key);

  @override
  State<GenerosResultBookPage> createState() => _GenerosResultBookPageState();
}

class _GenerosResultBookPageState extends State<GenerosResultBookPage> {
