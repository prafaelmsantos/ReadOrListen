...
Future<void> FirestoreCreateFavoritosAudiobooks (String audiobookId, String Capa, String Titulo, String Autor, String Id_favorito) async {
  //Vai buscar o id do utilizador currente.
  FirebaseAuth auth = FirebaseAuth.instance;
  String Id_utilizador =auth.currentUser.uid;

  // base de dados Favoritos
  CollectionReference favoritos = FirebaseFirestore.instance.collection('FavoritosAudio');

  return favoritos
      .doc(Id_favorito)
      .set({
    'Id_audiobook': audiobookId,
    'Capa': Capa,
    'Titulo': Titulo,
    'Autor': Autor,
...
Future<void>FirestoreFavoritoDeleteAudiobook(String Id_favorito) async{
  CollectionReference favoritos = FirebaseFirestore.instance.collection('FavoritosAudio');
