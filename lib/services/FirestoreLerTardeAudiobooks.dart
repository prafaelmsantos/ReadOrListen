...
Future<void> FirestoreCreateLerTardeAudiobooks (String audiobookId, String Capa, String Titulo, String Autor, String Id_lerTarde) async {
  //Vai buscar o id do utilizador currente.
  FirebaseAuth auth = FirebaseAuth.instance;
  String Id_utilizador =auth.currentUser.uid;

  // base de dados Ler mais tarde
  CollectionReference lerTarde = FirebaseFirestore.instance.collection('LerTardeAudio');
...
Future<void>FirestoreLerTardeDeleteAudiobook(String Id_lerTarde) async{
