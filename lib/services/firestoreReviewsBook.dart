...
Future<void> CreateReview(String _conteudo, double _avaliacao, String Id_livro) async {
  CollectionReference reviews = FirebaseFirestore.instance.collection('Reviews');
  CollectionReference utilizadores = FirebaseFirestore.instance.collection('Utilizadores');
      ...
      utilizadores.doc(uid).get().then((data) {
        ...
        reviews
            .doc(uid+Id_livro)
            .set({'Nome':uname,'Conteudo':_conteudo,'Foto':ufoto,'Data':_dateCreation,'Hora':_timeCreation, 'Avaliacao':_avaliacao,'Id_livro':Id_livro})
